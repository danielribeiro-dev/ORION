...
class AuditLogger:
    ...
    @staticmethod
    def log_action(user: User, intent: str, action_level: ActionLevel, allowed: bool, reason: str, metadata: Dict[str, Any] = None):
        """
        ...
        try:
            ...
            # Fallback crítico: Print no console se falhar escrita em disco
            print(f"[CRITICAL AUDIT FAILURE] {entry} - Error: {e}")
